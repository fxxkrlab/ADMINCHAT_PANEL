  ...
  return (
    <div className={`flex ${isInbound ? 'justify-start' : 'justify-end'} mb-3`}>
      ...
      >
        ...
        {textContent && (
          <div className="text-[14px] text-white leading-relaxed prose prose-invert prose-sm max-w-none [&_p]:my-0.5 [&_code]:text-accent [&_code]:bg-bg-elevated [&_code]:px-1 [&_code]:rounded [&_pre]:bg-bg-elevated [&_pre]:rounded [&_pre]:p-2 [&_a]:text-accent">
