...
function roleBadgeColor(role: string): string {
  switch (role) {
    case 'super_admin':
      return 'bg-[#8B5CF6]/15 text-purple border-[#8B5CF6]/20';
    case 'admin':
      return 'bg-accent/15 text-accent border-accent/20';
    default:
      return 'bg-[#059669]/15 text-green border-[#059669]/20';
  }
}
  ...
  return (
    <div className="flex h-screen overflow-hidden bg-bg-page">
      ...
      <div className="flex-1 flex flex-col overflow-hidden">
        {/* Top header bar */}
        <header className="flex items-center justify-end h-12 px-8 border-b border-border-subtle bg-bg-page shrink-0">
          <div className="flex items-center gap-3">
            ...
            <button
              ...
              className="flex items-center justify-center w-7 h-7 rounded-lg text-text-muted hover:text-red hover:bg-[#FF4444]/10 transition-colors"
              title="Logout"
            >
              <LogOut size={14} />
            </button>
