      ...
      <div className="flex-1 p-6 overflow-auto">
        ...
        <div className="flex items-center gap-4 mb-6 flex-wrap">
          ...
          <input
            ...
            className="flex-1 min-w-[200px] px-4 py-2 bg-bg-elevated border border-border rounded-lg text-sm text-text-primary placeholder:text-text-placeholder focus:outline-none focus:border-accent"
          />
          <select
            value={replyMode}
          ...
          <div className="flex items-center gap-6 flex-wrap">
            ...
            <div className="flex flex-col gap-1">
              ...
              <input
                ...
                min={0}
                className="w-24 px-3 py-2 bg-bg-elevated border border-border rounded-lg text-sm text-text-primary font-mono focus:outline-none focus:border-accent"
              />
            </div>
            <div className="flex flex-col gap-1">
              ...
              <input
                ...
                className="w-32 px-3 py-2 bg-bg-elevated border border-border rounded-lg text-sm text-text-primary font-mono placeholder:text-text-placeholder focus:outline-none focus:border-accent"
              />
            </div>
          </div>
        </div>
