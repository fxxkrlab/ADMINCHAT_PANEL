          ...
          >
            <div>
              ...
              <div className="relative">
                ...
                <input
                  ...
                  className="w-full h-10 pl-10 pr-4 bg-bg-page border border-border rounded-lg text-white text-sm placeholder:text-text-placeholder focus:outline-none focus:border-accent transition-colors"
            ...
            <div>
              ...
              <div className="relative">
                ...
                <input
                  ...
                  className="w-full h-10 pl-10 pr-10 bg-bg-page border border-border rounded-lg text-white text-sm placeholder:text-text-placeholder focus:outline-none focus:border-accent transition-colors"
            ...
            <div className="flex items-center gap-2">
              <input
                ...
                className="w-3.5 h-3.5 rounded border-border bg-bg-elevated text-accent focus:ring-[#00D9FF] focus:ring-offset-0 cursor-pointer"
              />
              <label
                htmlFor="remember"
            ...
            <button
              ...
              className="w-full flex items-center justify-center gap-2 h-11 bg-accent text-black font-semibold text-sm rounded-lg hover:bg-[#00C4E6] transition-colors disabled:opacity-50 disabled:cursor-not-allowed"
            >
              <LogIn size={16} />
